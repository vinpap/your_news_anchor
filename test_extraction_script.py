...
def test_article_page_parsing():
    ...
    try:
        ...
        print("test_article_page_parsing could not be run as a result. Please use another URL")
...
def test_author_filtering():
    ...
    assert extraction_functions.filter_authors(authors_list) == ["Jean-Jacques Dupont", "Jeanne Durand"]
